        ...
        >
            ...
            >
                <b-input
                    ...
                    :placeholder="Trans.get('user.user_group.form_group.input_description.code')"
            ...
            >
                <b-input
                    ...
                    :placeholder="Trans.get('user.user_group.form_group.input_description.name')"
            ...
            >
                <b-textarea
					...
					:placeholder="Trans.get('user.user_group.form_group.input_description.description')"
					:rows="3"
					:max-rows="6"
                    :disabled="isDisabled"
				/>
            ...
            <b-form-group
                ...
                :label="Trans.get('user.user_group.data_group.field_name.locked_data_mode')"
                label-align-md="right"
                label-class="pr-md-3"
                :label-cols-md="3"
            >
...
export default {
    ...
    computed: {
        ...
        fields() {
            return [
                ...
                {
                    key: "description",
                    label: this.Trans.get('user.user_group.data_group.field_name.description'),
                    thClass: "text-left",
                    tdClass: "text-left"
                },
                {
    ...
    methods: {
        ...
        updateData(data) {
            ...
            this.Web.setLoadingPage(true);
            this.Repo('moduserUserGroup').update({
                    id: data.id,
                    data: data,
                })
                .then((res) => {
        ...
        deleteData(id) {
            ...
            this.Web.showAlert({
                ...
                onOk: () => {
                    this.Repo('moduserUserGroup').delete({ id: id })
                        .then((res) => {
                            this.Web.showAlert({
                                title: this.Trans.get("alert.success_title"),
    ...
    created() {
        ...
        this.selectLockedDataMode = [
            {text:this.Trans.get('user.user_group.data_group.label.locked_data_mode_0'), value:0},
            {text:this.Trans.get('user.user_group.data_group.label.locked_data_mode_1'), value:1},
            {text:this.Trans.get('user.user_group.data_group.label.locked_data_mode_2'), value:2},
        ];
