      ...
      <div class="my-3">
        <b-row>
            ...
            <b-list-group class="account-settings-links" flush>
              ...
              <template v-for="(component, i) in profileTabAdds">
                <b-list-group-item
                  :key="i"
                  button
                  :active="curTab === component.id"
                  @click="curTab = component.id"
                  ><!-- v-if="AppConfig.packageLocal.moduser.user_profile_tab.profile.show == 1">-->
          ...
          <div class="col-md-9" v-show="curTab === 'general'">
            <b-card
              no-body
              class="overflow-hidden position-relative mb-0 ml-md-3 ml-md-3"
            >
              <b-card-header>
              ...
              <b-card-body class="pb-0">
                ...
                <b-form-group
                  :label="Trans.get('user.field_caption.username')"
                  label-align-md="right"
                  label-class="pr-md-3"
                  :label-cols-md="3"
                >
                ...
                <b-form-group
                  :label="Trans.get('user.field_caption.email')"
                  label-align-md="right"
                  label-class="pr-md-3"
                  :label-cols-md="3"
                >
                  ...
                  <b-alert
                    ...
                    class="mt-3 mb-0"
                    v-if="
                      !userForm.email_verified_at && userForm.email == oldEmail
                    "
                  >
                    Email Anda belum terverifikasi, silahkan cek email
                    verifikasi yang kami kirim, atau
                    <a
                      href="javascript:void(0)"
                      @click="sendVerification(userForm.id)"
                      class="small"
                    >
                ...
                <b-form-group
                  :label="Trans.get('user.field_caption.phone')"
                  v-if="showUserField('phone')"
                  label-align-md="right"
                  label-class="pr-md-3"
                  :label-cols-md="3"
                >
                  ...
                  >
                    ...
                    <br />
                    <a href="javascript:void(0)" v-if="false"
              ...
              <b-card-body class="pb-0">
                ...
                >
                  <b-input
                    :class="{
                      'form-control': true,
                      'is-invalid': $v.passwordForm.password.$error
                        ? true
                        : false,
                    }"
                    type="password"
                  ...
                  <invalid-tooltip
                    :inputItem="$v.passwordForm.password"
                ...
                >
                  <b-input
                    :class="{
                      'form-control': true,
                      'is-invalid': $v.passwordForm.password_confirmation.$error
                        ? true
                        : false,
                    }"
                    type="password"
                  ...
                  />
                  <invalid-tooltip
                    :inputItem="$v.passwordForm.password_confirmation"
                    :fieldName="
                      Trans.get('user.field_caption.confirm_password')
                    "
                    :customAlert="{
                      sameAsPassword: Trans.get(
                        'user.alert.password_not_match'
                      ),
                    }"
                  />
                </b-form-group>
          ...
          >
            ...
            >
              ...
              <b-card-body class="pb-0">
                <!-- inputan pin baru -->
                <b-form-group
                  :label="Trans.get('user.field_caption.pin')"
                  label-align-md="right"
                  label-class="pr-md-3"
                  :label-cols-md="3"
                >
                  <b-input
                    ...
                    :maxlength="authConfig.pin.digit"
                    v-model="pinForm.pin"
                  />
                  <invalid-tooltip
                ...
                <!-- confirm pin baru -->
                <b-form-group
                  :label="Trans.get('user.field_caption.confirm_pin')"
                  label-align-md="right"
                  label-class="pr-md-3"
                  :label-cols-md="3"
                >
                  <b-input
                    ...
                    :class="{
                      'form-control': true,
                      'is-invalid': $v.pinForm.confirm_pin.$error
                        ? true
                        : false,
                    }"
                    :maxlength="authConfig.pin.digit"
                  ...
                  <invalid-tooltip
                    :inputItem="$v.pinForm.confirm_pin"
                    :fieldName="Trans.get('user.field_caption.confirm_pin')"
                    :customAlert="{
                      sameAsPin: Trans.get('user.alert.pin_not_match'),
                    }"
                  />
                </b-form-group>
                <!-- / inputan pin baru -->
