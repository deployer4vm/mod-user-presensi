<template>
  <b-nav-item-dropdown no-caret :right="!isRTL" class="demo-navbar-notifications mr-lg-3">
    ...
    <b-list-group flush>
      <b-list-group-item class="media d-flex align-items-center" :to="{name: item.link_web.route, params: item.link_web.parameter}" v-for="item in notif.notification" :key="'navbarnotif-' + item.id">
