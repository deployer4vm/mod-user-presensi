            ...
            <b-card class="my-3" no-body>
                <b-card-body class="pb-0">
                    ...
                    <b-form-group v-if="canEditRoleType" :label="Trans.get('role.field_caption.role_type')" label-align-md="right" label-class="pr-md-3" :label-cols-md="3">
                        <b-select  :disabled="isDisabled" v-model="roleForm.role_type" :options="selectRoleType" class="form-control"/>
                    </b-form-group>
                    ...
                    <b-form-group v-if="canEditDashboard" :label="Trans.get('role.field_caption.dashboard_type')" label-align-md="right" label-class="pr-md-3" :label-cols-md="3">
                        <b-select :disabled="isDisabled" v-model="roleForm.dashboard_type" :options="selectDashboard" class="form-control"/>
                    </b-form-group>
    
                    <!-- Select Datarule -->
                    <b-form-group v-if="canEditDatarule" :label="Trans.get('role.field_caption.datarule_id')" label-align-md="right" label-class="pr-md-3" :label-cols-md="3">
                        <b-select :disabled="isDisabled" v-model="roleForm.datarule_id" :options="selectDatarule" class="form-control"/>
                    </b-form-group>
                    ...
                    <!-- GLOBA CONFIG -->
                    <div v-if="canEditGlobalRole">             
                        <!-- is_global -->
                        <b-form-group
                            :label="Trans.get('role.field_caption.role_type')" label-align-md="right" label-class="pr-md-3" :label-cols-md="3"
                        >
                            <b-select v-model="roleForm.is_global" :options="selectIsGlobal" class="form-control"/>
                        </b-form-group>
                        ...
                        <div>
                            <!-- global_bypass_rule -->
                            <b-form-group 
                                :label="Trans.get('role.field_caption.global_bypass_rule')" label-align-md="right" label-class="pr-md-3" :label-cols-md="3"
                            >
                                <b-select v-model="roleForm.global_bypass_rule" :options="selectGlobalBypass" class="form-control"/>
                            </b-form-group>
                            
                            <!-- global_bypass_datarule -->
                            <b-form-group 
                                :label="Trans.get('role.field_caption.global_bypass_datarule')" label-align-md="right" label-class="pr-md-3" :label-cols-md="3"
                            >
                                <b-select v-model="roleForm.global_bypass_datarule" :options="selectGlobalBypass" class="form-control"/>
                            </b-form-group>
                            ...
                            >
                                <b-select v-model="roleForm.global_bypass_dashboard" :options="selectGlobalBypass" class="form-control"/>
                            </b-form-group>
                            ...
                            >
                                <b-select v-model="roleForm.global_bypass_notification" :options="selectGlobalBypass" class="form-control"/>
                            </b-form-group>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...
        //
        canEditDashboard() {
            return !this.needBypassOnly || (this.roleForm.global_bypass_dashboard==1 || (this.roleForm.global_bypass_dashboard==2 && this.canBypassGlobal))
        },
        canEditDatarule() {
            return !this.needBypassOnly || (this.roleForm.global_bypass_datarule==1 || (this.roleForm.global_bypass_datarule==2 && this.canBypassGlobal))
        },
    },
    methods: {
