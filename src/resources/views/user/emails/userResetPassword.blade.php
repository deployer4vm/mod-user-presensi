...
<tr>
	<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
		<div style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;line-height:22px;text-align:left;color:#525252;">
			<p>Hai {{$name}},</p>
			<p>Anda baru saja melakukan permintaan untuk melakukan reset password untuk akun {{$app_name}} Anda. Klik tombol dibawah ini untuk melakukan reset password dan masukan password baru anda.</p>
		</div>
	</td>
</tr>
<tr>
