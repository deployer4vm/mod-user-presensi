    ...
    <div class="authentication-wrapper authentication-3">
        <div class="authentication-inner">
            ...
            <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5"
                style="background-image: url('/img/bg/21.jpg');">
            ...
            <div class="d-flex col-lg-4 align-items-center bg-white p-5">
                ...
                <div class="d-flex col-sm-7 col-md-5 col-lg-12 px-0 px-xl-4 mx-auto">
                    <div class="w-100">
                        ...
                        <h4 class="text-center text-lighter font-weight-normal mt-5 mb-0">
                            {{ config('AppConfig.system.template.admin.title') }}</h4>
                        <br><br>
                        <h5 class="text-center text-muted font-weight-normal mb-4">{{ __('auth.forgotpassword.title') }}
                        </h5>
                        ...
                        <form class="my-5" action="{{ route('auth.forgotPassword') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input name="email" type="text" class="form-control"
                                    placeholder="{{ __('auth.forgotpassword.emailcaption') }}">
                            </div>

                            <button type="submit"
                                class="btn btn-primary btn-block">{{ __('auth.forgotpassword.button') }}</button>
                        </form>
                        <!-- / Form -->
                        ...
                        <div class="w-100 py-3 px-4 px-sm-5">
                            <div class="text-center text-muted">
                                <a href="{{ route('auth.login') }}"
                                    class="d-block small">{{ __('auth.forgotpassword.back_to_login') }}</a>
                            </div>
                        </div>
